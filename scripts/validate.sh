...
required_files=(
  ...
  "$ROOT/core/references/adr.md"
  "$ROOT/core/references/architecture.md"
  "$ROOT/core/references/api-docs.md"
  "$ROOT/core/references/runbook.md"
  "$ROOT/core/references/postmortem.md"
  "$ROOT/core/references/readme-changelog.md"
  "$ROOT/core/references/onboarding-sop.md"
